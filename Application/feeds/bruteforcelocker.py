...
__url__ = Feeders.bruteforclocker.s_link
...
class bruteforcelocker(Feeder):
    __type__ = Type.Ip
    def __init__(self, type=__type__, name=__name__,by=__by__,sourcelink=Feeders.bruteforclocker.s_link,updateinterval=30):
